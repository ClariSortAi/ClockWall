...
A large digital clock sits at the top, with today's date underneath. Below that is a live list of the Claude Code agent sessions currently running on the machine.
